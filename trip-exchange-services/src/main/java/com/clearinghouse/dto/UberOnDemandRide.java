...
@Builder
public record UberOnDemandRide(
    ...
    @JsonProperty("return_trip_params") @JsonAlias({"return_trip","returnTrip","returnTripParams","return_trip_params"}) ReturnTrip returnTripParams,
