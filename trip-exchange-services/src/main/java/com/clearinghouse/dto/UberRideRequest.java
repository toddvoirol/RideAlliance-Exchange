...
public record UberRideRequest(
    ...
    @JsonProperty(value="communication_channel") String communicationChannel,
    ...
    // returnTripParams is intentionally typed as Object to allow ScheduledReturnTrip or FlexibleReturnTrip
    @JsonProperty("return_trip_params") @JsonAlias({"return_trip","returnTrip","return_trip_params","returnTripParams"}) Object returnTripParams,
    ...
    @JsonProperty(value="uber_fare",access = JsonProperty.Access.WRITE_ONLY) Double uberFare
) {}
