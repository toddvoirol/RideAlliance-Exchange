...
@Builder
public record UberReservedRideWithScheduledReturn(
    ...
    @JsonProperty("return_trip_params") @JsonAlias({"return_trip","returnTrip"}) ScheduledReturnTrip returnTripParams,
